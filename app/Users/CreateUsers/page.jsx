      ...
      <div className="mb-6">
        <div className="relative bg-gradient-to-r from-indigo-900 via-blue-800 to-cyan-800 rounded-2xl p-6 mb-6 overflow-hidden">
          ...
          <div className="relative z-10 text-white">
            <h1 className="text-4xl font-bold mb-3">User Management System</h1>
            <p className="text-indigo-100 text-lg leading-relaxed max-w-2xl">
              Comprehensive user administration and access control system for
              managing healthcare professionals, administrators, and system
            ...
            <div className="overflow-x-auto">
              <Table className="w-full border rounded-lg shadow-sm">
                <TableHeader className="bg-gray-50">
                  <TableRow>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-16 text-center">
                      #
                    </TableHead>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-48">
                      Name
                    </TableHead>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-56">
                      Email
                    </TableHead>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-32">
                      Phone
                    </TableHead>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-32">
                      Designation
                    </TableHead>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-28">
                      Area
                    </TableHead>
                    <TableHead className="px-4 py-3 font-semibold text-gray-700 text-sm w-24 text-center">
                      Role
                    </TableHead>
                  ...
                  {users.length > 0 ? (
                    users.map((user, idx) => (
                      ...
                      >
                        ...
                        {/* Actions */}
                        <TableCell className="px-4 space-x-2 py-3 w-28 text-center">
                          <Button
                          ...
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="border-green-200 text-black hover:bg-red-50 hover:border-red-300 px-3 py-1 text-xs rounded-lg"
                          >
                            Edit
                          </Button>
                        </TableCell>
